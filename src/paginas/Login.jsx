        ...
        <Card className="gradient-card border-muted card-hover overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="seu@email.com" required className="pl-10 p-2 border-input focus:ring-2 focus:ring-vibe-purple/50 px-[44px]" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {/* <Link to="/recuperar-senha" className="text-sm text-vibe-purple hover:text-vibe-purple-dark transition-colors">
                    Esqueceu a senha?
                  </Link> */}
                </div>
                <div className="relative">
          ...
          <CardFooter className="flex flex-col space-y-4 pb-6 pt-0">
            <div className="text-sm text-center mt-2">
              Não tem uma conta?{' '}
              <Link to="/registro" className="text-vibe-purple hover:text-vibe-purple-dark transition-colors font-medium">
                Registre-se
              </Link>
            </div>
          </CardFooter>
